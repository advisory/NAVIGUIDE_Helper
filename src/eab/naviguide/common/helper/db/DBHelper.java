...
public class DBHelper {
	...
	public static void connectToDB(String ipAddress) throws IOException {
		...
		if (isWindows) {
			...
			String[] commandQADBConnect = { "C:\\Program Files\\Git\\bin\\bash.exe", "-c",
					"ssh -N -L 54321:greendale-qa.ctwppe9uq1vi.us-east-1.rds.amazonaws.com:5432 greendale@"+ ipAddress + " -i "
							+ sshFilePath + " &" };
			if (!runCommand) {
